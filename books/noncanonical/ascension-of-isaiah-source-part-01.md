# Ascension of Isaiah — source part 01

## Source note

This file is based on the openly accessible English text of *The Ascension of Isaiah* from Early Christian Writings:
- Source URL: http://www.earlychristianwritings.com/text/ascension.html
- Accessed via `r.jina.ai` text mirror for stable retrieval

This is added as an external English witness for the `ethiopian-bible-ru` project.
It is not tied to the local `Digital_Ethipian_Bible_full.txt` pagination and should be treated as a working source text for future Russian drafting and comparison.
